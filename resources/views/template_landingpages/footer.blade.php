...
<footer id="footer" class="footer_area bg-black relative z-10 mt-5">
    <div class="shape absolute left-0 top-0 opacity-5 h-full overflow-hidden w-1/3">
        <img src="{{ asset('assets_landingpages') }}/images/footer-shape-left.png" alt="">
    </div>
    <div class="shape absolute right-0 top-0 opacity-5 h-full overflow-hidden w-1/3">
        <img src="{{ asset('assets_landingpages') }}/images/footer-shape-right.png" alt="">
    </div>
    <div class="container">
                ...
                <div class="w-full md:w-1/2 lg:w-3/12">
                    <div class="footer_about mt-13 mx-3">
                        <div class="footer_logo">
                            <a href="#"><img src="{{ asset('assets_landingpages') }}/images/logo-footer.svg"
                                    alt=""></a>
                        </div>
                ...
                <div class="w-full md:w-1/2 lg:w-5/12">
                    <div class="footer_link_wrapper flex flex-wrap mx-3">
                        <div class="footer_link w-1/2 md:pl-13 mt-13">
                            ...
                            <ul class="link pt-4">
                                <li><a href="#" class="text-white mt-4 hover:text-theme-color">Company</a>
                                </li>
                                <li><a href="#" class="text-white mt-4 hover:text-theme-color">Privacy
                                        Policy</a></li>
                                <li><a href="#" class="text-white mt-4 hover:text-theme-color">About</a>
                                </li>
                            </ul>
                        </div> <!-- footer link -->
                        <div class="footer_link w-1/2 md:pl-13 mt-13">
                            ...
                            <ul class="link pt-4">
                                <li><a href="#" class="text-white mt-4 hover:text-theme-color">Support</a>
                                </li>
                                <li><a href="#" class="text-white mt-4 hover:text-theme-color">Contact</a>
                                </li>
                                <li><a href="#" class="text-white mt-4 hover:text-theme-color">Terms</a>
                                </li>
                            </ul>
                        </div> <!-- footer link -->
        ...
        <div
            ...
            <div class="footer_social pt-4 mx-3 text-center">
                <ul class="social flex justify-center sm:justify-start">
                    <li class="mr-3"><a href="https://facebook.com/uideckHQ"><i
                                class="lni lni-facebook-filled"></i></a></li>
                    <li class="mr-3"><a href="https://twitter.com/uideckHQ"><i class="lni lni-twitter-filled"></i></a>
                    </li>
                    <li class="mr-3"><a href="https://instagram.com/uideckHQ"><i
            ...
            <div class="footer_copyright_content pt-4 text-center">
                <p class="text-white">Designed and Developed by <a href="https://uideck.com" rel="nofollow"
                        class="text-white hover:text-theme-color">UIdeck</a> and <a href="https://tailwindtemplates.co"
                        rel="nofollow" class="text-white hover:text-theme-color">Tailwind Templates</a></p>
...
<!--====== Tiny Slider js ======-->
<script src="{{ asset('assets_landingpages') }}/js/tiny-slider.js"></script>

<!--====== Wow js ======-->
<script src="{{ asset('assets_landingpages') }}/js/wow.min.js"></script>

<!--====== Main js ======-->
<script src="{{ asset('assets_landingpages') }}/js/main.js"></script>
